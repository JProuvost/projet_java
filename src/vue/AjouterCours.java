...
public class AjouterCours extends javax.swing.JPanel {
    ...
    private void initComponents(int a) {
        ...
        try{Personne prof = ecole.seekerPersonne(a);
        labelprof.setText(prof.getprenom()+" "+prof.getnom());
        ArrayList<Classe> classes=null;
        ArrayList<Trimestre> trimestres=null;
        
        ecole.getmine(ecole.seekerAnnee(annee),trimestres,classes);
        for(Discipline elem: ecole.getdiscipline()){
            c.addElement(elem.getnom());
        }
        for(Classe elem: classes){
            b.addElement(elem.getnom());
        }
        }
        ...
        fdiscipline.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        fclasse.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
