...
public class VoirLEleve extends javax.swing.JPanel {
    ...
    private void initComponents(int a) {
        ...
        try{
            if(a==0){
                ArrayList<Classe> alClasses = new ArrayList<>();
                ArrayList<Trimestre> trimestres = new ArrayList<>();
                e.getmine(new AnneeScolaire(annee), trimestres,alClasses);
                for(Classe elem: alClasses){
                    ...
                    e.getmine(elem, enseignements, inscriptions);
                ...
                for(Inscription inscription: inscriptions){
                    ...
                    String nom = etudiant.getnom();
                    String prenom = etudiant.getprenom();
                    Object[] data ={id,idetu,nom,prenom,"Afficher détail"};
                    tableModel.addRow(data);
                }
            }
    ...
    private void ajouterEleveActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        content.add(new EleveCommun(id),"EleveCommun");
        Fenetre.changePanel("EleveCommun");
    }                                             
    ...
    private String[] columnNames = {"id inscription","id etudiant","Nom","Prenom","Voir Eleve"};
