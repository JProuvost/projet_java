...
public class VoirClasse extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        try{e.getmine(e.seekerAnnee(annee), trimestres,alClasses);
        for(Classe elem: alClasses){
            int id = elem.getid();
            String nomniveau;
            String nom= elem.getnom();
            int idNiveau = elem.getidNiveau();
            try{Niveau niveau = e.seekerNiveau(idNiveau);
        ...
        Action selectprofesseur = new AbstractAction()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                content.add(new AfficherCours((int) table.getModel().getValueAt(modelRow,0)),"AjouterCours");
    ...
    private void ajouterClasseActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        content.add(new AjouterClasse(),"AjouterClasse");
        Fenetre.changePanel("AjouterClasse");
    }                                             
