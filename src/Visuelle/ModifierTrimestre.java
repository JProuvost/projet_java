...
public class ModifierTrimestre extends javax.swing.JPanel {
     ...
     */
    public ModifierTrimestre() {
        try{e.getmine(e.seekerAnnee(annee), trimestres, myClasse);}
        catch(Exception e)
        {
    ...
    private void validerActionPerformed(java.awt.event.ActionEvent evt,int b) {                                        
        ...
        try{
            AnneeScolaire a = e.seekerAnnee(b);
            e.getmine(a, t, new ArrayList<Classe>());
        }catch(Exception e){
            Fenetre.changePanel("accueil");
        }
        System.out.println("t1d : " + t1d);
        e.modifierTrimestre(t.get(0).getid(), t1d, t1f);
        e.modifierTrimestre(t.get(1).getid(), t2d, t2f);
        e.modifierTrimestre(t.get(2).getid(), t3d, t3f);
        Fenetre.changePanel("accueil");
    }  
